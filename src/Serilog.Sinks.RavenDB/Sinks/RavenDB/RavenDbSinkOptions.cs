...
namespace Serilog.Sinks.RavenDB
{
    ...
    {
        private TimeSpan? _expiration = null;
        private TimeSpan? _errorExpiration = null;
        ...
        public Func<global::Serilog.Events.LogEvent, TimeSpan> LogExpirationCallback { get; set; } = null;
    }
}
